#' Calculates the correlation permutation test
#'
...
#'@params alternative Alternative hypothesis for the permutation test. Takes one of the values: 
...
#'
#'@returns A data frame with names of variables in first two columns and p-value of correlation
#'test between the two variables in the third column. In the rows, all pairwise correlations are 
#'listed.
#'
#'@details For every pair of variables, for 'n_repetitions' times, a permutation of the samples is 
#'randomly chosen and the correlation between the original samples for variable i and permutated 
#'samples for variable j is calculated and compared to the tru correlation coefficiend. The p-value
#'is obtained as percentage of times when the "permuted" correlation was more significant that the
#'"true" correlation. If the 'alternative' equals "less", we count number of times "permuted" 
#'correlation is smaller than the "true" correlation. If the 'alternative' equals "greater", we count 
#'number of times "permuted" correlation is greater than the "true" correlation. If the 'alternative' 
#'equals "two_sided", we count number of times absolute value of "permuted" correlation is 
#'greater than the absolute value of the "true" correlation. If the 'alternative' equals 
#'"two_sided_signed", we count when "permuted" correlation is greater than the "true"
#' correlation for positive "true" correlation or when "permuted" correlation is smaller than the 
#' "true" correlation for negative "true" correlation.
#'
#'
#'@export
