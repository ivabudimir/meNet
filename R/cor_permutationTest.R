...
#' "true" correlation. If the 'alternative' is "less", we count number of times "permuted" 
#' correlation is smaller than the "true" correlation. If the 'alternative' is "greater", we count 
#' number of times "permuted" correlation is greater than the "true" correlation. If the 'alternative' 
#' is "two_sided", we count number of times absolute value of "permuted" correlation is 
#' greater than the absolute value of the "true" correlation. If the 'alternative' is 
